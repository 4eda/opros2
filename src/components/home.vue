  ...
  <div class="home">
    <h1>{{title}}</h1>
        <form class="form-signin flex-grow" action="" method="post">
                            ...
                            <div v-if="!isShow1">
                             <button class="btn btn-lg btn-success btn-block mt-2 mb-3" >Отправить</button>
                             </br>
                             </div>
                             <router-link to="/blog"><button class="btn btn-success">Далее</button></router-link>
                            </form>
  </div>
</template>
